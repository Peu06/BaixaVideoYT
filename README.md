...
- 📥 Download de vídeos a partir de URL
...
- 📝 Nome automático com título do vídeo
- ⚡ Execução simples no terminal
- 🔗 Integração com yt-dlp
- 🛠️ Tecnologias e Ferramentas
- ☕ Java
- 📦 Biblioteca java-youtube-dl
- 🎬 yt-dlp
...
## 🚧 Projeto simples, mas importante para construção de base sólida!

## ⭐ Sinta-se à vontade para explorar, testar e evoluir este projeto!
